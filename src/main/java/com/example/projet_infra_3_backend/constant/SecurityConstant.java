...
public class SecurityConstant {
    ...
    public static final String [] PUBLIC_URLS= {"/fiche/liste/**", "/user/login" , "/user/register/**","/user/image/**", "/swagger-ui/**", "/v2/api-docs","/swagger-resources/**", "/webjars/**","https://projet-infra-3-backend-dev.azurewebsites.net/**", "/user/**"};
}
